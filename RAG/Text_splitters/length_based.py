...
pdf_loader = PyPDFLoader("/home/jaimin.rana@agshealth.com/Documents/Projects/Generative AI/tech_current_affairs_2026.pdf")
...
print(len(chunks[len(chunks)-3].page_content))
